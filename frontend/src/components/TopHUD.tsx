...
export function TopHUD() {
  ...
  return (
    <header className="sticky top-0 z-30 h-14 border-b border-white/5 bg-[#070d1c]/80 backdrop-blur-xl">
      <div className="flex h-full items-center justify-between gap-3 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/"
            className="hidden md:inline-flex items-center gap-1.5 rounded-lg border border-white/10 px-3 py-1.5 text-xs text-text-secondary hover:text-white"
          >
